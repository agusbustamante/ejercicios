 ...
 */
// Por defecto no mostrar errores en producción; más abajo activamos
// display_errors para entornos locales detectados.
...
function cfg(): array {
    ...
    if ($is_hostinger) {
        // En Hostinger el servidor MySQL local suele ser 127.0.0.1:3306
        // Usar localhost/127.0.0.1 evita que la conexión salga por IPv6
        // o por la interfaz externa y provoque Access denied.
        return [
            'host'     => '127.0.0.1',
            'port'     => 3306,
