<?php
/*
 * modi.php — Modificación de liquidaciones
 *
 * Actualiza los campos de una liquidación existente. Soporta cambiar
 * el legajo (clave primaria) y actualiza el PDF si se envía uno
 * nuevo. Utiliza sentencias preparadas y requiere sesión válida.
 */
...
try {
    ...
    // Si se cargó un PDF, actualizarlo
