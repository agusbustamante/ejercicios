<?php
/*
 * baja.php — Baja de liquidaciones
 *
 * Elimina un registro de la tabla `liquidaciones` utilizando el
 * legajo como clave primaria. Responde con un JSON detallado.
 * Requiere sesión activa; en caso contrario redirige al formulario
 * de login.
 */
...
try {
    ...
    $sql = "DELETE FROM liquidaciones WHERE LegajoEmpleado = :legajo";
