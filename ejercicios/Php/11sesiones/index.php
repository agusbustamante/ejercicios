<?php
/*
 * index.php — Controlador de sesión y puerta de entrada a la aplicación
 *
 * Este archivo verifica si existe una sesión iniciada. En caso de que
 * no exista, redirige al formulario de login. Si la sesión está
 * activa, muestra información de la sesión (identificador, login de
 * usuario y contador de sesiones) y ofrece enlaces para ingresar al
 * módulo principal (app_modulo1) o para terminar la sesión.
 */
